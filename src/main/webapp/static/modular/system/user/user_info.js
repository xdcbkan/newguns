 ...
 * 管理员修改用户密码
 */
UserInfoDlg.modifyPwd = function () {
    var ajax = new $ax(Feng.ctxPath + "/mgr/modify", function (data) {
        Feng.success("修改成功!");
        UserInfoDlg.close();
    }, function (data) {
        Feng.error("修改失败!" + data.responseJSON.message + "!");
...
$(function () {
    ...
    $("#employeeType").val($("#employeeTypeValue").val());
    $("#maritalStatus").val($("#maritalStatusValue").val());
    $("#registrationType").val($("#registrationTypeValue").val());
    $("#educationValue").val($("#education").val());
    $("#politicalOutlook").val($("#politicalOutlookValue").val());
