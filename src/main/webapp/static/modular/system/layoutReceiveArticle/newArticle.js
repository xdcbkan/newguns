...
NewArticle.initColumn = function () {
    return [
        ...
        {title: '下载地址', field: 'dowanload_url', visible: true, align: 'center', valign: 'middle', formatter: operateFormatter}
    ];
};

function operateFormatter(value, row, index) {
    return ['<a target="_blank" href="'+row['dowanload_url']+'">点击查看</a>'
    ].join('')
}
