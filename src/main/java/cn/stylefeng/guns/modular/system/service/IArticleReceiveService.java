 ...
 * @since 2019-05-14
 */
public interface IArticleReceiveService extends IService<ArticleReceive> {
     ...
     * @return: int
     **/
    int updateReceive(Integer resultsEnforcement, Date operateTime, Integer articleId, Integer userId);
