...
//            registry.addResourceHandler("/attached/**").addResourceLocations("file:D:/MyFiles/attached/");
    ...
    public FilterRegistrationBean xssFilterRegistration() {
        ...
        xssFilter.setUrlExclusion(Arrays.asList("/notice/update", "/notice/add","/newArticle/update","/newArticle/add","/newArticle/addDraft","/newArticle/examineUpdate","/newArticle/returnArticle","/newArticle/layoutArticle",
                "/articleTask/add","/articleTask/update"));
